export default function Contact() {
    return(
        <section className="w-[86%] max-w-[1100.8px] mx-auto py-12">
            <h2 className="font-jetbrains uppercase text-light-txt dark:text-dark-txt text-3xl text-center">Contact</h2>
            <div className="text-light-txt dark:text-dark-txt">
                <div className="h-[2px] w-full bg-light-txt dark:bg-dark-txt my-7"></div>
            ...
            <div className="bg-light-txt text-light-secondary dark:bg-dark-txt dark:text-dark-secondary px-5 py-8 rounded-3xl">
