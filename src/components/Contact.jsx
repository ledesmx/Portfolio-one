...
export default function Contact() {
    return(
        <section className="w-[86%] max-w-[1100.8px] mx-auto py-12 lg:grid lg:grid-cols-4">
            ...
            <div className="bg-light-txt text-light-secondary dark:bg-dark-txt dark:text-dark-secondary px-5 py-8 rounded-2xl space-y-5 flex flex-col items-center lg:col-span-4 lg:mt-10 lg:flex-row lg:space-y-0 lg:py-10 lg:justify-evenly">
