...
export default function About() {
    return(
        <section className="w-[86%] mx-[7%] grid gap-y-10 md:gap-y-5">
            ...
            <div className="grid grid-cols-1 gap-y-10 md:grid-cols-3 md:gap-x-5">
                <div className="border-2 border-dark-txt p-5 rounded-xl flex flex-col md:col-span-2">
                ...
                <div className="border-2 border-dark-txt p-5 rounded-xl md:aspect-square">
