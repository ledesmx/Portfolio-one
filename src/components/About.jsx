...
export default function About() {
    return(
        <section className="w-[86%] max-w-[1100.8px] mx-auto grid gap-y-10 md:gap-y-5">
            <div className="grid grid-cols-1 gap-y-10 md:grid-cols-3 md:gap-x-5 lg:grid-cols-4 lg:grid-rows-1">
                <h2 className="font-jetbrains uppercase text-dark-txt text-3xl text-center md:col-span-3 lg:col-span-1">Who I am?</h2>
                <img 
                className="w-full"
                src={personalPhoto} 
                alt="personal photo" />
                <div className="border-2 border-dark-txt md:col-span-2 lg:col-span-2 rounded-xl p-5">
            ...
            <div className="grid grid-cols-1 gap-y-10 md:grid-cols-3 md:gap-x-5 lg:grid-cols-12">
                <div className="border-2 border-dark-txt p-5 rounded-xl flex flex-col md:col-span-2 lg:col-span-6 lg:col-start-2">
                ...
                <div className="border-2 border-dark-txt p-5 rounded-xl md:aspect-square lg:col-span-3 lg:col-start-9">
