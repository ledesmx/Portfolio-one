    ...
    return(
        ...
        className="min-h-[100vh] flex flex-col items-center justify-center text-light-primary dark:text-dark-primary">
            ...
            <p className="font-jetbrains flex text-xl mt-20 mb-auto opacity-70 text-light-primary dark:text-dark-primary lg:text-2xl">
                ...
                <span className="animate-type-20 mr-[.5px]">u</span>
                <span className="animate-type-30 mr-[.5px]">l</span>
                <span className="animate-type-40 mr-[.5px]">l</span>
                <span className="animate-type-50 mr-[.5px]">-</span>
                <span className="animate-type-60 mr-[.5px]">S</span>
                <span className="animate-type-70 mr-[.5px]">t</span>
                <span className="animate-type-80 mr-[.5px]">a</span>
                <span className="animate-type-90 mr-[.5px]">c</span>
                <span className="animate-type-100 mr-[12px] lg:mr-[16px]">k</span>
                <span className="animate-type-110 mr-[.5px]">D</span>
                <span className="animate-type-120 mr-[.5px]">e</span>
                <span className="animate-type-130 mr-[.5px]">v</span>
                <span className="animate-type-140 mr-[.5px]">e</span>
                <span className="animate-type-150 mr-[.5px]">l</span>
                <span className="animate-type-160 mr-[.5px]">o</span>
                <span className="animate-type-170 mr-[.5px]">p</span>
                <span className="animate-type-180 mr-[.5px]">e</span>
                <span className="animate-type-190 mr-[12px] lg:mr-[16px]">r</span>
